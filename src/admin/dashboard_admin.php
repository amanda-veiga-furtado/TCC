            ...
            <div class="container_form">
                ...
                <div style="position: relative; width: 90%; align-items: center;">
                    <form method="GET" action="">
                        <input type="text" name="search" id="search" placeholder="Pesquisar Usuário..."
                            style="width: 100%; padding-right: 40px; height: 40px; border-radius: 8px; border: 1px solid #ccc; box-sizing: border-box;"
                            value="<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>">
                        <button type="submit" class="button-search"
                            style="position: absolute; right: 0; top: 0; height: 40px; width: 10%; border-radius: 0 8px 8px 0; border: none;">
                    ...
                    if (!empty($usuarios)) {
                        foreach ($usuarios as $usuario) {
                            ...
                            <div class="projcard-small">
                                <a href="registro_usuario_admin.php?id_usuario=<?php echo $id_usuario; ?>"
                ...
                <div style="position: relative; width: 90%; align-items: center;">
                    <form method="GET" action="">
                        <input type="text" name="search" id="search"
                            placeholder="Pesquisar Nome da Receita ou ou Palavras do Modo de Preparo" style="width: 100%; padding-right: 40px; height: 40px; border-radius: 8px; 
                               border: 1px solid #ccc; box-sizing: border-box;">
                        <button type="submit" class="button-search" style="position: absolute; right: 0; top: 0; height: 40px; width: 10%; 
                ...
                try {
                    ...
                    if ($result_receita->rowCount() > 0) {
                        while ($row_receita = $result_receita->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            ?>
                            <div class="projcard">
                                <a href="../receita/registro_receita.php?id_receita=<?php echo htmlspecialchars($id_receita); ?>"
                                    style="text-decoration: none; display: block;">
                                    <div class="projcard-innerbox">
                                        ...
                                        <div class="projcard-textbox">
                                            <div class="projcard-title"
                                                style="color: var(--cinza-secundario); margin-bottom: 10px; margin-top: 10px"
                                            ...
                                            <div class="projcard-description">
                                                ...
                                                echo '<a href="registro_usuario_admin.php?id_usuario=' . htmlspecialchars($fk_id_usuario) . '" class="button-yellow" style="width: 9.3vw; margin-bottom: 10px; margin-top: 10px; text-align: center;" title="Ver criador da receita">';
                                                echo '<i class="fa-solid fa-user"></i>';
                                                echo '</a>';

                                                echo '<a href="../receita/registro_receita.php?id_receita=' . htmlspecialchars($id_receita) . '" class="button-yellow" style="width: 9.3vw; margin-bottom: 10px; margin-top: 10px; text-align: center;"title="Ver Receita">';

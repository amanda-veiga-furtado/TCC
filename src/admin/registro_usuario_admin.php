...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header("Location: registro_usuario_admin.php?id_usuario=$id_usuario");
    exit();
}
?>
<!DOCTYPE html>
            ...
            if (($result_usuario) && ($result_usuario->rowCount() != 0)) {
                ...
                <form method="POST" action="">
                    <input type="hidden" name="status"
                        value="<?php echo htmlspecialchars($statusAdministrador_usuario); ?>">
                    <br><br>
                    <button class="button-yellow" style="width: 46vw;" <?php echo ($statusAdministrador_usuario == 'a') ? 'disabled' : ''; ?>>
                        <?php

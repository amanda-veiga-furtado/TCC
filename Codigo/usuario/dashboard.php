        ...
        if ($count > 0) {
            ...
            if ($imagem_usuario) {
                ...
                if (move_uploaded_file($_FILES['imagem_usuario']['tmp_name'], $target_file)) {
                    ...
                    $_SESSION['mensagem'] = "Erro ao mover a imagem. Verifique as permissões do diretório.";
                }
            } else {
        ...
        <div class="whitecard_form">
            <div class="container_login">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <input type="text" name="nome_usuario" value="<?php echo $nome_usuario; ?>" required> <br>

...
<head>
    ...
    <style>
        .card {
            ...
            /* 3 cards por linha com espaço entre eles */
            margin: 10px;
            /* Ajuste a margem conforme necessário */
            box-sizing: border-box;
            /* Para garantir que a largura do card inclui a margem 
        ...
        .card img {
            ...
            object-fit: cover;
            /* Mantém a proporção e cobre o espaço */
        }
        ...
        .card-wrapper {
            width: 16.6%;
            /* Aproximadamente 1/6 da largura para 6 por linha */
            box-sizing: border-box;
            padding: 5px;
        }
        ...
        .cart-container {
            ...
            /* ou space-around */
            margin: 0 -10px;
            /* Ajuste conforme a margem desejada */
        ...
        .card-container.less-than-six .card {
            flex: 0 1 calc(33.33% - 20px);
            /* Define a largura dos cards quando há menos de 6 */
        }
...
<body>
 ...
 transition: transform 0.3s; transform: translateX(-91%);"></div>
                    ...
                    <div class="card">
                        ...
                        <div class="container">
                            <h3 title="<?php
                                ...
                                echo mb_strlen($nome_ingrediente) > 13 ? mb_substr($nome_ingrediente, 0, 14) . '...' : $nome_ingrediente;
                                ?>
                            </h3>
    ...
    <nav aria-label="Page navigation" style="background-color:white;>
        <div class=" div_pagintion">
        <ul class="pagination" style="list-style-type: none; background-color:white;">
            <?php
            // Mostrar os links para as páginas anteriores (máximo de 2)
            $inicio_pagina = max(1, $pagina - 2); // A primeira página pode ser 1, então nunca irá gerar um número de página negativo
            $fim_pagina = min($num_pagina, $pagina + 2); // A última página não pode ultrapassar o número total de páginas

            // Se a página atual for maior que 1, mostra o link de "anterior"
            if ($pagina > 1) { ?>
                <li>
            ...
            // Exibir links para as páginas anteriores
            for ($i = $inicio_pagina; $i < $pagina; $i++) { ?>
                <li><a href="?pagina=<?php echo $i; ?>&pesquisar=<?php echo htmlspecialchars($pesquisar); ?>"><?php echo $i; ?></a></li>
            <?php }
            ...
            // Se a página atual for menor que a última, mostra o link de "próximo"
    ...
    <div id="cartSidebar" class="cart-container">
        ...
        <div class="cart-header">
            <div class="form-title-big">
                ...
                <button style="font-size: 10px;"></button>

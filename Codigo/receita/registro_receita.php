...
<html lang="pt-br">
<head>
    <title><?php echo isset($row_receita['nome_receita']) ? htmlspecialchars($row_receita['nome_receita'], ENT_QUOTES, 'UTF-8') : "Receita"; ?></title>
    <meta charset="UTF-8">
...
<?php
    ...
    if ($result_receita && $result_receita->rowCount()) {
        ...
        // Exibe a porção
        echo "<h1>Porção</h1>" . floatval($row_receita['numeroPorcao_receita']) . " " . htmlspecialchars($porcao, ENT_QUOTES, 'UTF-8') . "<br>";
    ...
    echo "<div>";
        echo "<a href='editar_receita.php?id_receita=$id_receita' class='botao-2'>Editar</a>";
    echo "</div>";

?>

<!-- <a href='editar_receita.php?id_receita=$id_receita' class='botao-2'>Editar</a> -->
